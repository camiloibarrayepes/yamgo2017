...
<html lang="en-US"  data-menu="leftalign">
   ...
   <body class="page-template page-template-page_l page-template-page_l-php page page-id-2452">
      ...
      <div id="wrapper" class="hasbg transparent">
         ...
         <div id="page_caption" class="hasbg parallax" style="height:150px; background-image:url('../wp-content/uploads/2016/12/venice-WBEUROCITIES16.jpg');" >
               ...
               <div class="inner_wrapper">
                 <center>
                    ...
                    $query = "SELECT * FROM users WHERE id = '$id'";
                     ...
                     <form action="foto_upload_logic_1.php" method="POST" enctype="multipart/form-data">
                     <p>
                     <label>Sube una foto <br />
