...
<html lang="en-US"  data-menu="leftalign">
   ...
   <body class="page-template page-template-page_l page-template-page_l-php page page-id-2452">
      ...
      <div id="wrapper" class="hasbg transparent">
         ...
         <div id="page_caption" class="hasbg parallax" style="height:300px; background-image:url('../wp-content/uploads/2016/12/venice-WBEUROCITIES16.jpg');" >
         ...
         <div id="page_content_wrapper" class="hasbg ">
            <div class="inner">
               ...
               <div class="inner_wrapper">
                  ...
                  <form action="../logic/logic_new_bici.php" method="post" class="wpcf7-form" enctype="multipart/form-data">

                     <h4 class="p1">Agregar Datos de la Bici</h4>
                     <p><label> Marca<br />
                        <span class="wpcf7-form-control-wrap your-name">
                           <input type="text" name="marca" size="78" required/>
                           </span> </label>
                     </p>
                     <p><label> Color<br>
                        <span class="wpcf7-form-control-wrap your-name">
                           <input type="text" name="color"  size="78" required/>
                           </span> </label>
                     </p>
                      <p><label>Sube una foto de tu Bici <br />
                        <span class="wpcf7-form-control-wrap tel-729"><input class="form-control" type="file" name="photo1" id="imagen" required/></span> </label>
                     </p>
                     <input style="visibility: hidden;" type="text" name="id_user" value="<?php echo $_SESSION['ID']; ?>">                     

                      <p><input type="submit" value="Agregar Bici" onClick="validate()"/></p>
