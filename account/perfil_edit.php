      ...
      <div id="wrapper" class="hasbg transparent">
         ...
         ?>
                  ...
                  ?>
                     ...
                     <p><label> Telefono<br> 
                        <span class="wpcf7-form-control-wrap your-name">
                           <input type="text" name="telefono" value="<?php echo $row2['telefono']; ?>" size="78" required/>
                           </span> </label>
                     </p>

                     <p><label> Ciudad<br> 
                        <span class="wpcf7-form-control-wrap your-name">
                           <input type="text" name="ciudad" value="<?php echo $row2['ciudad']; ?>" size="78" required/>
                           </span> </label>
                     </p>
                   
                     <p><label> Reseña Personal<br>                    
                        <span class="wpcf7-form-control-wrap your-name">
                     ...
                     $qry=mysqli_query($link,"SELECT * FROM experiencias WHERE id_user = '$id'");     
                        ...
                        {echo "<br>";
                           print "<h5>".$historias['titulo']."</h5><br>";
                           ?>
                           <style>
                              .col-md-6,{
                             position: relative;
                           ...
                           <div class="row">
                             <div  class="col-md-6"><p align="justify" class="p1"><?php echo $historias['historia']; ?></p></div>
                             <div class="col-md-6"><br> <img  width="300px" style="border-radius: 15px; float: right;" class="wp-image-78 size-large" src="<?php echo $historias['foto']?>" width="1024" height="576" /></div>
                           </div><hr>
                     ...
                     <div class="sidebar">
                        ...
                        <div class="content">
                           ...
                           <!--<li style="background-color: #FAFAFA" id="grandtour_cat_posts-7" class="widget Grandtour_Cat_Posts">
                              ...
                              <!-- Fin modulo escribir una historia -->

                           <!--Modulo para ver Bicis de usuario -->
                           <?php
                           $id=$_SESSION['ID'];
                           /*  Comprobar si hay o no hay bicis START */
                           $sql = "SELECT * FROM bike WHERE id_user = '$id'";  // sentencia sql
                           $result = mysqli_query($link, $sql);
                           $numero = mysqli_num_rows($result);
                           if($numero==0)
                           {
