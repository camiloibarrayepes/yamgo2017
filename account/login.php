...
/* <![CDATA[ */
var _zxcvbnSettings = {"src":"http:\/\/themes.themegoods2.com\/grandtour\/demo\/wp-includes\/js\/zxcvbn.min.js"};
/* ]]> */
</script>
...
<link rel="alternate" type="application/json+oembed" href="../wp-json/oembed/1.0/embed-url=http_%7C%7Cthemes.themegoods2.com%7Cgrandtour%7Cdemo%7Cmy-account%7C.json" />
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed-url=http_%7C%7Cthemes.themegoods2.com%7Cgrandtour%7Cdemo%7Cmy-account%7C&format=xml.xml" />
...
<body class="page-template-default page page-id-8 woocommerce-account woocommerce-page">
	...
	<input type="hidden" id="tg_lightbox_opacity" name="tg_lightbox_opacity" value="0.8"/>
		...
		<input type="hidden" id="tg_cart_url" name="tg_cart_url" value="http://themes.themegoods2.com/grandtour/demo/cart/"/>
...
<div class="mobile_menu_wrapper">
    ...
    <div class="menu-main-menu-container"><ul id="mobile_main_menu" class="mobile_main_nav"><li id="menu-item-11" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children menu-item-11"><a href="../index.html">Home</a>
<ul class="sub-menu">
...
<li id="menu-item-12" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-12"><a href="index.html#">Tours</a>
<ul class="sub-menu">
	<li id="menu-item-198" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-198"><a href="../tour/tour-3-columns-classic/index.html">Tour Classic Fullwidth</a>
	<ul class="sub-menu">
	...
	<li id="menu-item-230" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-230"><a href="../tour/tour-2-columns-classic-right-sidebar/index.html">Tour Classic Sidebar</a>
	<ul class="sub-menu">
	...
	<li id="menu-item-237" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-237"><a href="../tour/tour-3-columns-grid/index.html">Tour Grid Fullwidth</a>
	<ul class="sub-menu">
	...
	<li id="menu-item-247" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-247"><a href="../tour/tour-grid-right-sidebar/index.html">Tour Grid Sidebar</a>
	<ul class="sub-menu">
	...
	<li id="menu-item-256" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-256"><a href="../tour/tour-list-right-sidebar/index.html">Tour List Sidebar</a>
	<ul class="sub-menu">
	...
	<li id="menu-item-261" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-261"><a href="../tour/tour-3-columns-grid/index.html">Tour Header Type</a>
	<ul class="sub-menu">
...
<li id="menu-item-200" class="menu-item menu-item-type-post_type menu-item-object-tour menu-item-has-children menu-item-200"><a href="../tour/the-new-california/index.html">Booking</a>
<ul class="sub-menu">
...
<li id="menu-item-13" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-13"><a href="index.html#">Destinations</a>
<ul class="sub-menu">
...
<li id="menu-item-14" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-14"><a href="index.html#">Pages</a>
<ul class="sub-menu">
...
<li id="menu-item-15" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-15"><a href="index.html#">Blog</a>
<ul class="sub-menu">
...
<li id="menu-item-16" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-16"><a href="index.html#">Shortcodes</a>
<ul class="sub-menu">
...
<li id="menu-item-2442" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2442"><a href="../shop/index.html">Shop</a>
<ul class="sub-menu">
    	...
    	<div class="sidebar_wrapper">
            <div class="sidebar">
            	...
            	<div class="content">
            		...
            		<li id="grandtour_tour_posts-10" class="widget Grandtour_Tour_Posts">					<div class="one gallery1 grid static filterable portfolio_type themeborder" style="background-image:url('../wp-content/uploads/2016/12/pexels-photo-26689-700x466.jpg');">	
	        ...
	        <div id="nav_wrapper">
	        	<div class="nav_wrapper_inner">
	        		<div id="menu_border_wrapper">
	        			<div class="menu-main-menu-container"><ul id="main_menu" class="nav"><li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-has-children arrow menu-item-11"><a href="../index.html">Home</a>
<ul class="sub-menu">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children arrow menu-item-12"><a href="index.html#">Tours</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-198"><a href="../tour/tour-3-columns-classic/index.html">Tour Classic Fullwidth</a>
	<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-230"><a href="../tour/tour-2-columns-classic-right-sidebar/index.html">Tour Classic Sidebar</a>
	<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-237"><a href="../tour/tour-3-columns-grid/index.html">Tour Grid Fullwidth</a>
	<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-247"><a href="../tour/tour-grid-right-sidebar/index.html">Tour Grid Sidebar</a>
	<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-256"><a href="../tour/tour-list-right-sidebar/index.html">Tour List Sidebar</a>
	<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-261"><a href="../tour/tour-3-columns-grid/index.html">Tour Header Type</a>
	<ul class="sub-menu">
...
<li class="menu-item menu-item-type-post_type menu-item-object-tour menu-item-has-children arrow menu-item-200"><a href="../tour/the-new-california/index.html">Booking</a>
<ul class="sub-menu">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children arrow menu-item-13"><a href="index.html#">Destinations</a>
<ul class="sub-menu">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children arrow menu-item-14"><a href="index.html#">Pages</a>
<ul class="sub-menu">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children arrow menu-item-15"><a href="index.html#">Blog</a>
<ul class="sub-menu">
...
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children arrow menu-item-16"><a href="index.html#">Shortcodes</a>
<ul class="sub-menu">
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-2442"><a href="../shop/index.html">Shop</a>
<ul class="sub-menu">
...
<div id="page_content_wrapper" class=" ">
	...
	<div id="portfolio_filter_wrapper" class="gallery grid four_cols portfolio-content section content clearfix" data-columns="4">
		...
		<div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-1" style="background-image:url('../wp-content/uploads/2016/12/bf1202aedf2c5b6a57d379575619a488-700x466.jpg');">	
			<a class="tour_image" href="../tour/seoul-your-soul/index.html"></a>	
			<div class="portfolio_info_wrapper">
		...
		<div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-2" style="background-image:url('../wp-content/uploads/2016/12/39267772-prague-wallpapers-700x466.jpg');">	
			<a class="tour_image" href="../tour/exclusive-prague-trip/index.html"></a>	
			<div class="portfolio_info_wrapper">
								<div class="tour_price has_discount">
											<span class="normal_price">
							$5,900						</span>
						$5,500									</div>
				        	    <h5>Exclusive Prague Trip</h5>
        	    <div class="tour_attribute_wrapper">
	        	    						<div class="tour_attribute_rating">
											<div class="br-theme-fontawesome-stars-o">
								<div class="br-widget">
		...
		<div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-3" style="background-image:url('../wp-content/uploads/2016/12/pexels-photo-197657-700x466.jpeg');">	
			<a class="tour_image" href="../tour/grand-switzerland/index.html"></a>	
			<div class="portfolio_info_wrapper">
								<div class="tour_price ">
											$6,000									</div>
		...
		<div class="one_fourth gallery4 grid static filterable portfolio_type themeborder" data-id="post-4" style="background-image:url('../wp-content/uploads/2016/12/pexels-photo-96420-700x466.jpeg');">	
			<a class="tour_image" href="../tour/discover-japan/index.html"></a>	
			<div class="portfolio_info_wrapper">
								<div class="tour_price has_discount">
											<span class="normal_price">
							$3,000						</span>
						$2,500									</div>
				        	    <h5>Discover Japan</h5>
        	    <div class="tour_attribute_wrapper">
	        	    						<div class="tour_attribute_rating">
											<div class="br-theme-fontawesome-stars-o">
								<div class="br-widget">
...
<img src="../wp-content/uploads/2016/12/awards.png" width="246" height="113" style="margin-top:30px;" alt=""/></p>
</div>
		</li>
...
<li id="grandtour_instagram-9" class="widget Grandtour_Instagram"><h2 class="widgettitle">Recent Trips</h2>
<ul class="flickr"><li><a target="_blank" href="https://www.instagram.com/p/BRgXWsqFBLD/"><img src="https://scontent.cdninstagram.com/t51.2885-15/s320x320/e35/c0.134.1080.1080/17125594_1309391605815084_2848303834034339840_n.jpg" width="75" height="75" alt="" /></a></li><li><a target="_blank" href="https://www.instagram.com/p/BRbMpSplJqX/"><img src="https://scontent.cdninstagram.com/t51.2885-15/s320x320/e35/c0.134.1080.1080/15035595_1936401566587633_4455313788257697792_n.jpg" width="75" height="75" alt="" /></a></li><li><a target="_blank" href="https://www.instagram.com/p/BRYn2YXBttX/"><img src="https://scontent.cdninstagram.com/t51.2885-15/s320x320/e35/17125477_337451106650656_7516217094694764544_n.jpg" width="75" height="75" alt="" /></a></li><li><a target="_blank" href="https://www.instagram.com/p/BRWDLtvh7vb/"><img src="https://scontent.cdninstagram.com/t51.2885-15/s320x320/e35/17076229_257140138075403_4619417127063912448_n.jpg" width="75" height="75" alt="" /></a></li><li><a target="_blank" href="https://www.instagram.com/p/BRTeTR-hMus/"><img src="https://scontent.cdninstagram.com/t51.2885-15/s320x320/e35/17125985_183374232163594_1946321832420311040_n.jpg" width="75" height="75" alt="" /></a></li><li><a target="_blank" href="https://www.instagram.com/p/BROVWFIBoRG/"><img src="https://scontent.cdninstagram.com/t51.2885-15/s320x320/e35/17125543_273774926379985_565758286507278336_n.jpg" width="75" height="75" alt="" /></a></li></ul><br class="clear"/></li>
</ul>
</div>
...
<div class="footer_bar   ">
	...
	<div class="footer_bar_wrapper ">
		<div class="menu-footer-menu-container"><ul id="footer_menu" class="footer_nav"><li id="menu-item-215" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-215"><a href="../index.html">Home</a></li>
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_add_to_cart_params = {"ajax_url":"\/grandtour\/demo\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/grandtour\/demo\/my-account\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/themes.themegoods2.com\/grandtour\/demo\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
/* ]]> */
</script>
<script type='text/javascript' src='../wp-content/plugins/woocommerce/assets/js/frontend/add-to-cart.min.js'></script>
<script type='text/javascript' src='../wp-content/plugins/woocommerce/assets/js/select2/select2.min.js'></script>
<script type='text/javascript'>
/* <![CDATA[ */
...
<script type='text/javascript'>
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/grandtour\/demo\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/grandtour\/demo\/my-account\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/grandtour\/demo\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/grandtour\/demo\/my-account\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
...
Object Caching 7716/7786 objects using disk
Page Caching using disk: enhanced
Database Caching 4/43 queries in 0.013 seconds using disk (Request-wide DONOTCACHEDB constant defined)

 Served from: themes.themegoods2.com @ 2017-03-12 05:22:40 by W3 Total Cache -->