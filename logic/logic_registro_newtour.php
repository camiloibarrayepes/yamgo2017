...
$query = "INSERT INTO tour (`id_user`, `nombre`, `destino`, `origen`, `fecha_salida`, `fecha_llegada`, `hora_salida`, `hora_llegada`, `contacto`, `cupos`, `email_contacto`, `telefono_contacto`, `vigencia`, `foto`) VALUES('$id_user', '$nombre','$destino', '$origen', '$fecha_salida', '$fecha_llegada', '$hora_salida', '$hora_llegada', '$contacto', '$cupos', '$email_contacto', '$telefono_contacto', '$vigencia', '$direccionimagen2')";
