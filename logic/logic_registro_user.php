...
$nuevo_usuario=mysqli_query($link, "select nombre from users where email='$email'"); 
$nuevo_usuario2=mysqli_query($link, "select nombre from users where username='$username'"); 
...
{ 
  ?>
    <b> El Username que tratas de registrar, ya esta en uso<BR>
...
$ruta="assets/imagenes/usuarios";
$ruta2="assets/imagenes/usuarios";
if(!file_exists($ruta)){
