                                       ...
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children arrow menu-item-2442">
                                        ...
                                        <a><?php echo "Hola ".$_SESSION['NAME']; ?></a>
                                          <ul class="sub-menu">
                                             ...
                                             <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-348"><a href="tours_users">Mis Tours</a></li>
                                             <?php $rol=$_SESSION['ROL'];
                                             if(($rol==2)or($rol==3))
                                             {
                                             ?>
                                             <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-353"><a href="shortcodes/animated-content/index.html">Mis Bicis</a></li>
                                             <?php
                                             }
                                             ?>
