...
<html lang="en-US"  data-menu="leftalign">
   <head>
      ...
      <title><?php echo $_REQUEST['usr']; ?></title>
      ...
      <meta property="og:image" content="http://themes.themegoods2.com/grandtour/demo/wp-content/uploads/2016/12/pexels-photo-225630-960x636.jpeg"/>
      <meta property="og:title" content="5 Lake of Fuji San"/>
      <meta property="og:url" content="http://themes.themegoods2.com/grandtour/demo/tour/5-lake-of-fuji-san/"/>
      <meta property="og:description" content="Mountain, Rural, Urban"/>
      <link rel="alternate" type="application/rss+xml" title="Grand Tour | Booking Travel WordPress &raquo; 5 Lake of Fuji San Comments Feed" href="http://themes.themegoods2.com/grandtour/demo/tour/5-lake-of-fuji-san/feed/" />
      ...
      <link rel='prev' title='Swiss Alps Trip' href='../swiss-alps-trip/index.html' />
      <link rel='next' title='The New California' href='../the-new-california/index.html' />
      <meta name="generator" content="WordPress 4.7.3" />
      <meta name="generator" content="WooCommerce 2.6.14" />
      <link rel="canonical" href="index.html" />
      <link rel='shortlink' href='index.html' />
      <link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed-url=http_%7C%7Cthemes.themegoods2.com%7Cgrandtour%7Cdemo%7Ctour%7C5-lake-of-fuji-san%7C.json" />
      <link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed-url=http_%7C%7Cthemes.themegoods2.com%7Cgrandtour%7Cdemo%7Ctour%7C5-lake-of-fuji-san%7C&format=xml.xml" />
      <meta name="generator" content="Powered by Slider Revolution 5.3.1.5 - responsive, Mobile-Friendly Slider Plugin for WordPress with comfortable drag and drop interface." />
   </head>
   <body class="tour-template-default single single-tour postid-164">
               ...
               <ul id="mobile_main_menu" class="mobile_main_nav">
                  ...
                  <li id="menu-item-200" class="menu-item menu-item-type-post_type menu-item-object-tour current-menu-ancestor current-menu-parent menu-item-has-children menu-item-200">
                     ...
                     <ul class="sub-menu">
                        ...
                        <li id="menu-item-276" class="menu-item menu-item-type-post_type menu-item-object-tour current-menu-item menu-item-276"><a href="index.html">Booking + Affiliate Tour</a></li>
      ...
      <div id="wrapper" class="hasbg transparent">
         ...
         <div id="page_caption" class="hasbg parallax" style="height:350px; background-image:url('../../wp-content/uploads/2016/12/39267772-prague-wallpapers-1024x690.jpg');" >
            ...
            <div class="inner">
               ...
               <div class="inner_wrapper">
                  <div class="sidebar_content">
                     ...
                     Es guía en 
                     <div class="page_tagline">
                        <div style="text-transform: capitalize;"><?echo $row2['ciudad'];?></div>
                     </div>
                     ...
                     <div class="single_tour_content">
                        <h4 class="p1"><?php echo "Perfil de ".$row2['nombre']; ?></h4>
                        <p class="p1">
                        <?php  echo $row2['perfil']; ?>
                        </p>

                        
                        <!-- Fin While para info de usuario -->
                      
                     <br>

                     <?php
                              $id_user_3=$row2['id'];
                              $qry2=mysqli_query($link,"SELECT * FROM guias WHERE id_user='$id_user_3'");     
                     ...
                     <ul class="single_tour_departure_wrapper themeborder">
                        <li>
                           <div class="single_tour_departure_title">Ciudad</div>
                        ...
                        <li>
                           <div class="single_tour_departure_title">Idiomas</div>
                           <div class="single_tour_departure_content"><?php echo $row3['idiomas']; ?></div>
                        </li>
                        <!--
                        <li>
                     ...
                     <!--fin while row3 para guias en esta seccion-->
                     <?php } ?>

                     <!-- Inicio logica, si es presta biker se muestran bicis que tiene -->
                     <?php 
                     $rol=$row2['rol'];
                     if($rol==3)
                     {
                     ...
                     <h4 class="p1">
                     <?php 
                     $primernombre=explode(" ", $row2['nombre']); 
                     echo $primernombre[0]." Tiene Bicis disponibles" ?></h4>
                     <div class="standard_wrapper">
                        <div id="portfolio_filter_wrapper" class="gallery classic two_cols portfolio-content section content clearfix" data-columns="3">
                           
                              <?php 
                              $id_userbici=$row2['id'];
                              $query = "SELECT * FROM bike WHERE id_user = '$id_userbici'";
                              $resultado2 = $link->query($query);
                              while($bicis = $resultado2->fetch_assoc())
                              {
                              ?>
                              <div style="width:300px; margin: 12px;"  class="one_half gallery2 classic static filterable portfolio_type themeborder" data-id="post-13">
                                 <a class="tour_image" href="../colorful-singapore/index.html">
                                    <img style="height: 225px; padding-right: 200px" src="<?php echo "../../logic/".$bicis['foto']; ?>" alt="Colorful Singapore" />
                                    <div class="tour_price has_discount">
                                       <span>Precio</span>
                                       $1,700                                       
                                    </div>
                              ...
                              <div class="portfolio_info_wrapper">
                                 <a class="tour_link" href="../colorful-singapore/index.html">
                                    <h4 style="text-transform: capitalize;"><?php echo $bicis['marca']." - ".$bicis['color']; ?></h4><br>
                                 </a>
                                 </div>
                              </div>
                     ...
                     <br><br>
                        ...
                        <div>
                           ...
                           <div class="comment" id="comment-16">
                              <div class="gravatar">
                                 <img src="../../wp-content/uploads/2016/12/author1-100x100.jpg" width="60" height="60" alt="Jack Dawson" class="avatar avatar-60 wp-user-avatar wp-user-avatar-60 alignnone photo" />      	
                              </div>
                              <div class="right ">
                                 <h7>Jack Dawson</h7>
                           ...
                           <div class="comment" id="comment-17">
                              <div class="gravatar">
                                 <img src="../../wp-content/uploads/2016/12/me-100x100.jpg" width="60" height="60" alt="Anna Kornikova" class="avatar avatar-60 wp-user-avatar wp-user-avatar-60 alignnone photo" />      	
                              </div>
                              <div class="right ">
                           ...
                           <div class="comment" id="comment-18">
                              <div class="gravatar">
                                 <img src="../../wp-content/uploads/2016/12/avatar-100x100.png" width="60" height="60" alt="Marie Argeris" class="avatar avatar-60 wp-user-avatar wp-user-avatar-60 alignnone photo" />      	
                              </div>
                              <div class="right ">
                                 <h7>Marie Argeris</h7>
                                 <div class="comment_date">December 15, 2016 at 2:41 pm</div>
                           ...
                           <div class="comment" id="comment-19">
                              ...
                              <div class="right ">
                                 ...
                                 <div class="comment_date">December 15, 2016 at 2:41 pm</div>
                                 <a rel='nofollow' class='comment-reply-link' href='index-replytocom=19.html#respond' onclick='return addComment.moveForm( "comment-19", "19", "respond", "164" )' aria-label='Reply to Jessica Medina'>Reply</a>						
                                 <div class="comment_text"/>
                     ...
                     <div class="sidebar">
                        <div class="content">
                           ...
                           $qry=mysqli_query($link,"SELECT * FROM users WHERE username='$username'");     
                              ...
                              $qry2=mysqli_query($link,"SELECT * FROM guias WHERE id_user='$idguia'");     
                           ...
                           <div class="single_tour_header_price">
                              <div class="single_tour_price">
                                 $<?php echo $row1['precio']; ?>												
                              </div>
                              <div class="single_tour_per_person">
                                 <?php echo "Por ".$row1['tiempo']; ?>					
                              </div>
                           </div>
                           <div class="single_tour_booking_wrapper themeborder external">
                              <div class="single_tour_booking_external_wrapper">
                                 <?php $primernombre=explode(" ", $row['nombre']); 
                                    echo $primernombre[0]." Te puede guiar por lugares como: ".$row1['lugares'];
                                    ?>
                                 <a href="https://themeforest.net/user/themegoods/portfolio" class="button">Contactar con <?php echo $primernombre[0];?></a>
                              </div>
                           ...
                           <?php
                              ...
                              ?>
                           <a id="single_tour_share_button" href="javascript:;" class="button ghost themeborder"><span class="ti-email"></span>Escribele a <?php echo $primernombre[0]; ?></a>
                           <ul class="sidebar_widget">
                              <li id="text-3" class="widget widget_text">
                                 <h2 class="widgettitle">Para mas información comunicate con YAMGO</h2>
                                 <div class="textwidget"><span class="ti-mobile" style="margin-right:10px;"></span>(+57) 321 773 6762
                                    <br/>
                                    <span class="ti-alarm-clock" style="margin-right:10px;"></span>Lunes - Sabado 8.00 - 18.00
                                 </div>
                              </li>
                           </ul>
                        </div>
               ...
               <div class="tour_related">
                  ...
                  <div class="element grid classic3_cols animated2">
                        <div class="one_third gallery3 classic static filterable portfolio_type themeborder" data-id="post-2">                        
                           <a class="tour_image" href="../../tours/users_tours/ver.php?id=<?php echo $tour['id'];?>">
                           <?php
                           if(empty($tour['foto']))
                              {
                           ?>
      ...
      <div id="side_menu_wrapper" class="overlay_background">
         ...
         <div id="fullscreen_share_wrapper">
            <div class="fullscreen_share_content">
               <h2>Share</h2>
               <div class="page_tagline">5 Lake of Fuji San</div>
               <div id="social_share_wrapper">
                  <ul>
                     <li><a class="facebook" title="Share On Facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://themes.themegoods2.com/grandtour/demo/tour/5-lake-of-fuji-san/"><span class="ti-facebook"></span></a></li>
                     <li><a class="twitter" title="Share On Twitter" target="_blank" href="https://twitter.com/intent/tweet?original_referer=http://themes.themegoods2.com/grandtour/demo/tour/5-lake-of-fuji-san/&url=http://themes.themegoods2.com/grandtour/demo/tour/5-lake-of-fuji-san/"><span class="ti-twitter"></span></a></li>
                     <li><a class="pinterest" title="Share On Pinterest" target="_blank" href="http://www.pinterest.com/pin/create/button/?url=http://themes.themegoods2.com/grandtour/demo/tour/5-lake-of-fuji-san/&media=http://themes.themegoods2.com/grandtour/demo/wp-includes/images/media/default.png"><span class="ti-pinterest"></span></a></li>
                     <li><a class="google" title="Share On Google+" target="_blank" href="https://plus.google.com/share?url=http://themes.themegoods2.com/grandtour/demo/tour/5-lake-of-fuji-san/"><span class="ti-google"></span></a></li>
                     <li><a class="mail" title="Share by Email" href="mailto:someone@example.com?Subject=5%20Lake%20of%20Fuji%20San&amp;Body=http%3A%2F%2Fthemes.themegoods2.com%2Fgrandtour%2Fdemo%2Ftour%2F5-lake-of-fuji-san%2F"><span class="ti-email"></span></a></li>
                  </ul>
               </div>
            </div>
         </div>
      ...
      <script type='text/javascript'>
         /* <![CDATA[ */
         var wc_add_to_cart_params = {"ajax_url":"\/grandtour\/demo\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/grandtour\/demo\/tour\/5-lake-of-fuji-san\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/themes.themegoods2.com\/grandtour\/demo\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
         /* ]]> */
      </script>
      ...
      <script type='text/javascript'>
         /* <![CDATA[ */
         var woocommerce_params = {"ajax_url":"\/grandtour\/demo\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/grandtour\/demo\/tour\/5-lake-of-fuji-san\/?wc-ajax=%%endpoint%%"};
         /* ]]> */
      </script>
      ...
      <script type='text/javascript'>
         /* <![CDATA[ */
         var wc_cart_fragments_params = {"ajax_url":"\/grandtour\/demo\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/grandtour\/demo\/tour\/5-lake-of-fuji-san\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
         /* ]]> */
      </script>
      ...
      <script type='text/javascript' src='../../wp-admin/admin-ajax-action=grandtour_script_map_shortcode&data=a_3_%7Bs_2__id__s_22__map1489291878749923730__s_4__zoom__s_2__13__s_4__type__s_0____%7D.php'></script>
      <script type='text/javascript' src='../../wp-content/themes/grandtour/js/jquery.cookie.js'></script>
      <script type='text/javascript' src='../../wp-admin/admin-ajax-action=grandtour_script_demo.php'></script>
   </body>
</html>
<!-- Performance optimized by W3 Total Cache. Learn more: https://www.w3-edge.com/products/
   Object Caching 8266/8786 objects using disk
   Page Caching using disk: enhanced
   Database Caching 12/221 queries in 0.048 seconds using disk
   
    Served from: themes.themegoods2.com @ 2017-03-12 04:11:18 by W3 Total Cache -->