                              ...
                              <form action="../logic/logic_registro_newtour.php" method="post" class="wpcf7-form" enctype="multipart/form-data">
                                 ...
                                 <p><label> Origen<br />
                                  ...
                                  <p><label> Contacto Organizador<br />
                                    <span class="wpcf7-form-control-wrap tel-729"><input type="text" name="contacto" value="" size="70"  required/></span> </label>
                                 </p>
                                  <p><label> Email de Contacto<br />
                                    <span class="wpcf7-form-control-wrap tel-729"><input type="email" name="email_contacto" value="" size="70"  required/></span> </label>
                                 </p>
                                  <p><label> Telefono de Contacto<br />
                                    <span class="wpcf7-form-control-wrap tel-729"><input type="text" name="telefono_contacto" value="" size="70"  required/></span> </label>
                                 </p>
